...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_succeedsWtihEmptyDataOnHTTPURLResponseWithNilData() {
    ...
    private class URLProtocolStub: URLProtocol {
        ...
        override func startLoading() {
            if let requetObserver = URLProtocolStub.requestObserver {
                client?.urlProtocolDidFinishLoading(self)
                URLSessionHTTPClientTests.URLProtocolStub.requestObserver?(request)
                return requetObserver(request)
            }
